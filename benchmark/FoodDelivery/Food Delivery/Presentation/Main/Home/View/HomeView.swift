...
struct HomeView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
                    ...
                    .overlay(
                        ZStack(content: {
                            Image(systemName: "cart")
                                ...
                                .accessibilityValue("\(vm.savedFoods.reduce(0) { $0 + Int($1.quantity) }) items")
                                ...
                                Circle()
                                    ...
                                    .overlay(
                                        Text("\(vm.savedFoods.count)")
                                            ...
                                            .accessibilityIdentifier("home.cart.itemCount"),
                                        alignment: .center
                                    )
            ...
            if !vm.categories.isEmpty && !vm.foods.isEmpty && !vm.restaurants.isEmpty {
                Text("Catalog ready")
                    .frame(width: 1, height: 1)
                    .opacity(0.01)
                    .accessibilityIdentifier("home.catalogReady")
            }
